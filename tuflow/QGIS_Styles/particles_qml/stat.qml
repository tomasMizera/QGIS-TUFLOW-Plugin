...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" version="3.13.0-Master" simplifyAlgorithm="0" minScale="100000000" maxScale="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" attr="stat" enableorderby="0" symbollevels="0">
    <categories>
      <category value="1" label="Suspended" symbol="0" render="true"/>
      <category value="2" label="Sediment" symbol="1" render="true"/>
      <category value="3" label="Dry" symbol="2" render="true"/>
      <category value="Other" label="Other" symbol="3" render="true"/>
    </categories>
    <symbols>
      <symbol type="marker" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="21,81,221,255"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;stat&quot;" sortOrder="1">
    <columns>
