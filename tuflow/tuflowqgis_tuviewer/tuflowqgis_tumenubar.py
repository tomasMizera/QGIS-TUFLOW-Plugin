...
class TuMenuBar():
	...
	def loadFileMenu(self):
		...
		if self.menu is None:
			...
			self.loadScattered_action = QAction('Load Results - Scattered Data', self.window)
			...
			self.fileMenu.addAction(self.loadScattered_action)
			...
			self.loadScattered_action.triggered.connect(self.tuMenuFunctions.loadScatteredData)
